...
const depression: DiseaseResult = {
  ...
  papers: [
    {
      title:
        "CACNA1C risk variants modulate cortical excitability in mood disorders",
    ...
    {
      title:
        "Serotonin transporter occupancy and antidepressant response: a meta-analysis",
      journal: "Molecular Psychiatry",
      year: 2023,
      targets: ["SLC6A4", "HTR2A"],
    },
    {
      title:
        "BDNF signaling as a convergent mechanism in treatment-resistant depression",
      journal: "Cell Reports Medicine",
      year: 2024,
      targets: ["BDNF"],
    },
    {
      title: "NMDA receptor modulation and rapid-acting antidepressants",
      journal: "Neuron",
      year: 2022,
      targets: ["GRIN2B"],
    },
    {
      title: "Inflammatory cytokine TNF-α as a stratification biomarker in MDD",
...
const schizophrenia: DiseaseResult = {
  ...
  papers: [
    {
      title:
        "Dopamine D2 receptor occupancy thresholds across antipsychotic classes",
      journal: "The Lancet Psychiatry",
      year: 2023,
      targets: ["DRD2"],
    },
    {
      title: "Complement C4A copy number and synaptic pruning in schizophrenia",
      journal: "Nature",
      year: 2022,
      targets: ["C4A"],
    },
    {
      title: "Metabotropic glutamate receptor 3 as a procognitive target",
      journal: "Molecular Psychiatry",
      year: 2024,
      targets: ["GRM3", "GRIN2A"],
    },
    {
      title: "TCF4 regulatory networks in neurodevelopmental risk",
      journal: "Cell",
      year: 2023,
      targets: ["TCF4"],
    },
    {
      title: "Neuroinflammation and IL-6 signaling in first-episode psychosis",
      journal: "Biological Psychiatry",
      year: 2024,
      targets: ["IL6"],
    },
...
const bipolar: DiseaseResult = {
  ...
  targets: [
    ...
    {
      symbol: "TRANK1",
      name: "Tetratricopeptide repeat and ankyrin repeat 1",
      score: 0.78,
      modality: "Small Molecule",
      resource: "Transcriptomics",
    },
  ...
  papers: [
    {
      title: "Lithium response and GSK3β inhibition: mechanistic insights",
      journal: "Molecular Psychiatry",
      year: 2023,
      targets: ["GSK3B"],
    },
    {
      title: "ANK3 and CACNA1C convergence on neuronal excitability",
      journal: "Nature Neuroscience",
      year: 2024,
      targets: ["ANK3", "CACNA1C"],
    },
    {
      title: "Genome-wide association of bipolar disorder identifies TRANK1",
...
const autism: DiseaseResult = {
  ...
  papers: [
    {
      title: "SHANK3 haploinsufficiency and synaptic scaffolding deficits",
      journal: "Neuron",
      year: 2023,
      targets: ["SHANK3"],
    },
    {
      title: "CHD8 regulates neurodevelopmental gene expression programs",
      journal: "Cell",
      year: 2022,
      targets: ["CHD8"],
    },
    {
      title: "SCN2A channelopathies across the autism-epilepsy spectrum",
      journal: "Nature Neuroscience",
      year: 2024,
      targets: ["SCN2A", "GRIN2B"],
    },
  ],
}
